...
public class Strings {
    ...
    public static String randomChars(int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            build.append(new String(b, CharsetUtils.GBK));
        }
    ...
    public static byte[] bytes(String s, Charset charset) {
        ...
        return s.getBytes(Charsets.of(SystemUtils.FILE_ENCODING));
    }
    ...
    public static byte[] bytes(String s, String charset) {
        if (charset != null) {
            return s.getBytes(CharsetUtils.of(charset));
        }
        return s.getBytes(CharsetUtils.of(SystemUtils.FILE_ENCODING));
    }
