...
public abstract class Const {
    ...
    public static final String CAKE_KIT = "cake-kit";

    public static final String DISPLAY = ".cake";

    public static final String VERSION = "1.0.5";

    public static final String AUTHOR = "zhongwang";

    public static final String AUTHOR_CN = "钟望";

    public static final String AUTHOR_EMAIL = "18668485565@163.com";

    public static final String AUTHOR_GITHUB = "https://github.com/WXzhongwang";
