package com.rany.cake.toolkit.lang.random;
...
public class RndGenerator {
    ...
    public RndGenerator() {
        this((System.currentTimeMillis() >> 16 | SystemUtils.getProcessCode()) * 32, 4);
    }
    ...
    public RndGenerator(int bit) {
        this((System.currentTimeMillis() >> 16 | SystemUtils.getProcessCode()) * 32, bit);
    }
