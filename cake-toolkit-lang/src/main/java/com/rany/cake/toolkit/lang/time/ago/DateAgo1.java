package com.rany.cake.toolkit.lang.time.ago;


import com.rany.cake.toolkit.lang.time.DateStream;
import com.rany.cake.toolkit.lang.time.Dates;

import java.util.Date;

import static com.rany.cake.toolkit.lang.time.Dates.stream;
        ...
        if (target.before(source)) {
            ...
            if (sMonth > tMonth) {
                if (sMonth - tMonth == 1 && strict) {
                    if (sDay >= tDay) {
                        ...
                        return (Dates.getMonthLastDay(sYear, sMonth) - (tDay - sDay)) + hint.dayAgo;
                    }
                } else {
            ...
            if (sMonth < tMonth) {
                if (tMonth - sMonth == 1 && strict) {
                    if (sDay >= tDay) {
                        return (Dates.getMonthLastDay(sYear, sMonth) + (tDay - sDay)) + hint.dayFuture;
                    } else {
